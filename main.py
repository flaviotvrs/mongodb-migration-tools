...
parser.add_argument("--origin", "-o", dest = "origin", required = True, help = "Connection string of the original cluster containing credentials and database")
parser.add_argument("--destination", "-d", dest = "destination", required = True, help = "Connection string of the destination cluster containing credentials and database.")
parser.add_argument("--collection", "-c", dest = "collection", required = False, help = "Specifies a collection to backup. If you do not specify a collection, this option copies all collections in the specified database or instance to the dump files.")
